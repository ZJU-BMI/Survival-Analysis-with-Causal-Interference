...
mimic_data <- read.csv('results/mimic_data_final5.csv')
...
# mimic_data2 <- subset.data.frame(mimic_data, tte <= 120)
...
write.csv(mimic_data3, 'results/mimic_data_final.csv', row.names = F)
write.csv(mimic_data4, 'results/mimic_data_final6.csv', row.names = F)
