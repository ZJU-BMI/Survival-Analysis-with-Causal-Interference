...
def import_dataset_mimic(norm_mode=None):
    df_                = pd.read_csv('./data/mimic_data.csv')

    bin_list           = ['gender']
    cont_list          = ['age', 'gender', 'hematocrit', 'potassium', 'sodium', 'creatinine', 'chloride',
                          'urea_nitrogen', 'bicarbonate', 'glucose', 'anion_gap', 'ph', 'magnesium',
                          'platelet_count', 'hemoglobin', 'white_blood_cells', 'mchc',
                          'red_blood_cells', 'mch', 'mcv', 'rdw', 'base_excess', 'calculated_total_co2',
                          'po2', 'pco2', 'ptt', 'phosphate', 'total_calcium', 'inr', 'pt', 'rr', 'hr', 'sbp',
                          'dbp', 'temperature', 'sao2', 'spo2', 'cvp', 'height', 'weight']
