...
data_mode = 'SYNTHETIC'  # EICU, MIMIC, SYNTHETIC
seed = 1234
    ...
    for r_itr in range(RS_ITERATION):
        ...
        if tmp_max > max_valid:
            ...
            save_logging(max_parser,
                         log_name)  # save the hyper-parameters if this provides the maximum validation performance
