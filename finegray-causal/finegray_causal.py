...
from finegray_layer import finegray_layer
...
class FG_Model:
    ...
    def _build_net(self):
        with tf.variable_scope(self.name):
            ...
            for i in range(self.num_events):
                beta_x_out = finegray_layer(self.x, self.num_events, w_init=self.initial_w,
                                            w_reg=self.reg_w)
    ...
    def loss_log_likelihood(self):
        ...
        for i in range(self.num_events):
            ...
            sum_sub_distribution = tf.reduce_sum(sum_beta_x) - tf.reduce_sum(sum_log_x)
            neg_likelihood_loss += sum_sub_distribution
