DROP MATERIALIZED VIEW IF EXISTS pat_info2;
CREATE MATERIALIZED VIEW pat_info2 AS (
	WITH height AS (
	...
	SELECT idf.subject_id, idf.hadm_id
		...
		, sep, ch, arf, mi, hf, pneu, ci, sh, nobl, col, akf, ca, leu, hepf, panc, vt, diab 
	...
	FROM mimic_icu.icu_diag_first2 idf
