...
pat_info <- read.csv('datas/pat_info.csv')
lab_feats <- read.csv('datas/lab_features.csv')
vital_signs <- read.csv('datas/vital_signs.csv')
drugs <- read.csv('datas/drug.csv')
...
# 去除缺失值较多的行
feat_col <- pat_feats_final[, 12:117]
